...
// AFRICA UNITED TOKEN - created bt Autoken Consultancy Team
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfeB324e3923e0b6121B31Ed0502A4f8A9Bced78a; //Wallet for contract owner
...
contract AfricaUnitedToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe9e2485f8Da0AcB6B481BbA6D7C0F8d43f0019A2; //AUT Development wallet
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18; //Total number of tokens to be created 100million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Africa United Token";
    string private _symbol = "AUT";
    uint8 private _decimals = 8;
    uint256 public _taxFee = 50; //Reflection @ 5%
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 50; // Crowd Funding,Investors and Administration
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 30; //Liquiadity pool @3%
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Pancakeswap Router V2
